      ...
      >
        ...
        <a
          ...
          <div className=" w-full md:block md:w-auto" id="navbar-dropdown">
            <ul className={`flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-transparent md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ${textColor}   dark:border-gray-700`}>
              {menuItems.map((item) => (
                <li key={item.name}>
                  <a
                    href={item.url}
